...
def Vor_der_Schanze():
  ...
  print("\n")
  print("""************************** ALTSCHAUERBERG ADVENTURE- THE ALMIGHTY RUDI TAPES ***********************
...
def Hausflur():
  ...
  Links geht es in den sagenumwobenen Radelraum und geradeaus hindurch geht es zur Küche, dem Badezimmer und natürlich dem Streamzimmer. 
  ...
  if "1" in answer:
    ...
    if "j" in answer:
      ...
      if "1" in answer:
        ...
        Auf dem Zettel steht "alfanumerisches Paswort" und "Drachenlord1510". Wofür kann das wohl gut sein? Du gehst wieder zurück
...
# 		if "1" in answer:
# 			print("\n"
# 			game_over("lorem ipsum dolor sit amet")
					
# 	else: print("lorem ipsum dolor sit amet"
